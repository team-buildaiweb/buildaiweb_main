    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-gray-600 mb-4">
            Get the latest AI web development insights delivered to your inbox weekly.
          </p>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-wrap gap-2">
            {popularTags.map((tag) => (
              <Badge key={tag} variant="outline" className="hover:bg-purple-50 hover:border-purple-300 cursor-pointer">
                {tag}
              </Badge>
            ))}
          </div>
      ...
      <Card className="bg-gradient-to-br from-purple-50 to-blue-50 border-purple-200">
        <CardContent className="p-6 text-center">
          ...
          <p className="text-sm text-gray-600 mb-4">Try our AI website builder and create your site in minutes.</p>
          <Link href="/dashboard">
            <Button className="bg-purple-600 hover:bg-purple-700">Start Building</Button>
          </Link>
        </CardContent>
      </Card>
    </div>
