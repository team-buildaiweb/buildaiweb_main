...
import { Send, Sparkles, CheckCircle, User, Mail, MessageSquare, Lightbulb } from "lucide-react"
...
export function ContactForm() {
  ...
  const generateAISuggestions = (idea: string): string[] => {
    ...
    if (lowerIdea.includes("restaurant") || lowerIdea.includes("food")) {
      suggestions.push("Add online ordering system", "Include menu showcase", "Integrate reservation booking")
    } else if (lowerIdea.includes("portfolio") || lowerIdea.includes("creative")) {
      suggestions.push("Add image gallery", "Include client testimonials", "Create contact form")
    } else if (lowerIdea.includes("ecommerce") || lowerIdea.includes("store")) {
      suggestions.push("Add shopping cart", "Include payment processing", "Create product catalog")
    } else if (lowerIdea.includes("saas") || lowerIdea.includes("software")) {
      suggestions.push("Add pricing tiers", "Include feature comparison", "Create user dashboard")
    } else {
      suggestions.push("Add contact form", "Include social media links", "Create responsive design")
    }
      ...
      <Card className="border-green-200 bg-green-50">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Thank you for reaching out! Our AI has analyzed your request and our team will get back to you within 2
    ...
    <Card className="shadow-xl border-0">
      <CardHeader className="bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-t-lg">
        ...
        <p className="text-purple-100">
          Our AI will analyze your request and help us provide the best possible response
        </p>
      </CardHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Tell us about your website vision. What kind of site do you want to build? What's its purpose?"
            ...
            {isSubmitting ? (
              <div className="flex items-center justify-center">
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm opacity-75">Processing requirements</div>
                </div>
              </div>
            ) : (
              <>
