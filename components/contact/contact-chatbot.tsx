  ...
  const generateResponse = (userMessage: string): { content: string; suggestions?: string[] } => {
    ...
    if (lowerMessage.includes("pricing") || lowerMessage.includes("cost") || lowerMessage.includes("price")) {
      return {
        ...
        suggestions: ["Schedule a pricing call", "See feature comparison", "Start free trial"],
      }
    }
    ...
    if (lowerMessage.includes("demo") || lowerMessage.includes("try") || lowerMessage.includes("test")) {
      return {
        content:
          "I'd love to show you our AI in action! You can try our interactive demo right now, or I can schedule a personalized demo call with one of our specialists.\n\nThe demo shows how you can build a complete website just by describing what you want in plain English.",
        suggestions: ["Try the demo now", "Schedule demo call", "See example websites"],
      }
    }
    ...
    if (lowerMessage.includes("custom") || lowerMessage.includes("enterprise") || lowerMessage.includes("business")) {
      return {
        ...
        suggestions: ["Schedule business call", "Get custom quote", "See enterprise features"],
      }
    }
    ...
    if (lowerMessage.includes("support") || lowerMessage.includes("help") || lowerMessage.includes("problem")) {
      return {
        ...
        suggestions: ["Technical support", "Billing question", "Feature request"],
      }
    }
    ...
    return {
      ...
      suggestions: ["Schedule a call", "Send email", "Book demo", "Continue chatting"],
    }
  }
    ...
    <Card className="shadow-xl border-0 h-[600px] flex flex-col">
      <CardHeader className="bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-t-lg flex-shrink-0">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-purple-100 text-sm">Alex is online and ready to help</span>
        </div>
      </CardHeader>
