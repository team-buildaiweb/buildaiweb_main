...
const faqs = [
  ...
  {
    question: "Can I schedule a demo of the AI mobile app builder?",
    answer:
  ...
  },
  {
    ...
    answer:
      "The more details you provide about your project, the better we can help you. Include your mobile app goals, target audience, preferred timeline, and any specific features you need. Our AI will analyze this information to provide better recommendations.",
  },
  {
  ...
  {
    question: "Can you help migrate my existing mobile app?",
    answer:
      "Yes, we can help migrate content from your existing mobile app to a new AI-generated site. We also offer redesign services where we use AI to create a modern version of your current site while preserving your content and SEO rankings.",
  },
];
    ...
    <section className='mt-20'>
      <div className='text-center mb-12'>
        ...
        <p className='text-gray-600 max-w-2xl mx-auto'>
          Find quick answers to common questions about our AI mobile app builder
          and services.
        </p>
      </div>
