...
const steps = [
  {
    ...
    description:
      "Tell our AI what kind of mobile app you want to build using natural language",
  },
  {
    icon: Cpu,
    title: "AI Generates App + UI/UX",
    description:
      "Our advanced AI creates a complete mobile app with screens, navigation, and functionality",
  },
  {
    icon: Eye,
    title: "Preview & Customize",
    description:
      "Review your generated app in our mobile simulator and make any adjustments you need",
  },
  {
    icon: Rocket,
    title: "Export / Deploy to App Stores",
    description:
      "Download your code or deploy directly to Apple App Store and Google Play Store",
  },
];
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            Our streamlined workflow makes mobile app development accessible to
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
            {steps.map((step, index) => (
              <div key={index} className='relative'>
                ...
                {/* Step Number Circle */}
                <div className=' absolute -top-4 left-1/2 transform -translate-x-1/2 w-8 h-8 bg-purple-600 rounded-full flex items-center justify-center text-white font-bold text-sm z-20'>
                  {index + 1}
                </div>
              </div>
            ))}
