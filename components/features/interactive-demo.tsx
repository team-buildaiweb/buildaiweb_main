...
import { Play, RefreshCw, Copy, Check, Code, Eye, Loader2, Sparkles } from "lucide-react"
...
const demoPrompts = [
  ...
  "Create a consulting firm website with team profiles and case studies",
]
...
export function InteractiveDemo() {
  ...
  const handleGenerate = async () => {
    ...
    if (lowerPrompt.includes("portfolio") || lowerPrompt.includes("photographer")) {
    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Try Our AI Live Demo</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Experience the magic of AI web development. Type a description and watch as our AI creates a complete
            website in seconds.
          </p>
        </div>
            ...
            <Card className="shadow-xl">
              <CardContent className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900">Describe Your Website</h3>
                </div>
                  ...
                  {isGenerating ? (
                    <div className="h-full flex items-center justify-center bg-gradient-to-br from-purple-50 to-blue-50">
                      <div className="text-center max-w-sm">
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 mb-2">AI is building your website...</h3>
                        <p className="text-gray-600 mb-6">Creating something amazing for you</p>
                    ...
                    <div className="h-full flex items-center justify-center bg-gray-50">
                      <div className="text-center max-w-sm">
                        ...
                        <p className="text-gray-600">
                          Enter a description of your website and watch our AI create it in real-time.
                        </p>
                      </div>
                    </div>
                  )}
