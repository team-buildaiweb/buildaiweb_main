...
const faqs = [
  ...
  {
    question: "Can I export my mobile apps and cancel my subscription?",
    answer:
      "You own all the mobile apps you create. You can export your code at any time and host it anywhere. Even if you cancel your subscription, you keep all your generated mobile apps and code.",
  },
  {
  ...
  {
    question: "How does the AI mobile app generation work?",
    answer:
      "Our AI analyzes your text description and generates a complete mobile app including layout, content, styling, and responsive design. The process typically takes 2-5 minutes and produces production-ready code that you can customize further or use as-is.",
  },
  {
    question:
      "Is there a limit to how much I can customize the generated mobile apps?",
    answer:
