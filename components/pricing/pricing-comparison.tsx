                ...
                <thead>
                  <tr className="border-b border-gray-200 bg-gray-50">
                    ...
                    <th className="text-center py-4 px-6 font-semibold text-purple-600">
                      <div className="flex flex-col items-center">
                        <span>Pro</span>
                        <Badge className="mt-1 text-xs bg-purple-600">Popular</Badge>
                      </div>
                    </th>
                    <th className="text-center py-4 px-6 font-semibold text-gray-900">
                      <div className="flex flex-col items-center">
                    ...
                    <>
                      ...
                      {category.items.map((item, itemIndex) => (
                        <tr key={`${categoryIndex}-${itemIndex}`} className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          <td className="py-4 px-6 text-center bg-purple-50">{renderFeatureValue(item.pro)}</td>
                          <td className="py-4 px-6 text-center">{renderFeatureValue(item.business)}</td>
