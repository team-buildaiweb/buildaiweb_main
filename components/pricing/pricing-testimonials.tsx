...
const testimonials = [
  {
    ...
    plan: "Pro",
    content:
      "The Pro plan has transformed my workflow. I can now deliver websites to clients in hours instead of weeks. The unlimited builds and premium templates are worth every penny.",
    rating: 5,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            See how businesses of all sizes are saving time and money with BuildAIWeb.
          </p>
        </div>
            ...
            <Card key={index} className="shadow-lg border-0 hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <div className="flex items-center justify-between">
                  <Badge className="bg-purple-100 text-purple-800">{testimonial.plan} Plan</Badge>
                  <div className="text-sm text-green-600 font-medium">{testimonial.savings}</div>
                </div>
              </CardContent>
            </Card>
          ))}
