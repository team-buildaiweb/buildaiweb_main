  ...
  const cultureValues = [
    {
      ...
      image: "/images/work-life_balance.webp",
    },
    {
      icon: Lightbulb,
      ...
      image: "/images/innovation_time.webp",
    },
    {
      icon: Users,
      ...
      image: "/images/inclusive_community.webp",
    },
    {
      icon: Globe,
      title: "Remote-First",
    ...
    },
    {
      ...
      image: "/images/learning_culture.webp",
    },
    {
      icon: Zap,
      title: "Move Fast",
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mt-20 text-center'>
          <blockquote className='text-2xl font-light text-gray-700 max-w-4xl mx-auto leading-relaxed'>
            "At BuildAIWeb, we're not just building a product – we're building
            the future of how people create on the web. Our culture reflects
            that ambition: innovative, inclusive, and always pushing
            boundaries."
          </blockquote>
          <div className='mt-6'>
