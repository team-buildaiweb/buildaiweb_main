      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
            Numbers that showcase the growing community of creators using
            BuildAIWeb
          </p>
        </div>
        ...
        <div className='mt-16 text-center'>
          <div className='bg-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-4xl mx-auto'>
            ...
            <p className='text-gray-300 text-lg leading-relaxed'>
              Our community continues to grow as more creators discover the
              power of AI-driven mobile app development. Join thousands of
              entrepreneurs, designers, and businesses who are building their
              digital presence with BuildAIWeb.
            </p>
          </div>
        </div>
      </div>
