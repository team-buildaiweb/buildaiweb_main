...
const popularPages = [
  {
    ...
    description: "Try our interactive demo and build your first AI mobile app",
    href: "/dashboard",
    icon: Zap,
    category: "Product",
    popular: true,
  ...
  },
  {
    ...
    description: "Learn about AI mobile app development and best practices",
    href: "/blog",
    icon: BookOpen,
    category: "Resources",
    popular: false,
...
const quickActions = [
  {
    ...
    description: "Jump right into creating your mobile app",
    href: "/dashboard",
    icon: Zap,
  ...
  {
    title: "View Examples",
    description: "See mobile apps built with our AI",
    href: "/examples",
    icon: Compass,
...
const recentUpdates = [
  ...
  },
  {
    ...
    description: "Build mobile apps on the go",
    time: "1 week ago",
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
          ...
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 mb-8 max-w-2xl mx-auto'>
              ...
              digital void. But don't worry – our AI can help you find what you
              need!
            </p>
                ...
                <Card className='text-center py-12'>
                  <CardContent>
                    ...
                    <p className='text-gray-600 mb-4'>
                      We couldn't find any pages matching "{searchQuery}". Try a
              ...
              <Card className='bg-gradient-to-br from-purple-50 to-blue-50 border-purple-200'>
                <CardContent className='p-6 text-center'>
                  ...
                  <p className='text-sm text-gray-600 mb-4'>
                    Our AI assistant and support team are here to help you find
